"""
Django settings for oauth2_authentication project.
...
SECRET_KEY = 'ho5avp6acg8s@tqr#7b--970kk33#$jz24vnxjyz#^u0njl198'
...
ROOT_URLCONF = 'oauth2_authentication.urls'
...
WSGI_APPLICATION = 'oauth2_authentication.wsgi.application'
